...
public class Update_horse {
			...
			public static int arrCheckj(int j,int i)
			{
				System.out.println("Checking "+j+" is present at"+i+" in ind arr");
				
				System.out.println(ind[i][1]+ " checking equal to "+j);
				System.exit(0);
						if(ind[i][1]==j)
						{
							System.out.println("j returning "+(j));
							ind[i][1]=-1;
							return j;
						}
